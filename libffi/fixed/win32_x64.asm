...
ALIGN 8; ORG 0b + (15) * 8
	call	abort
ALIGN 8; ORG 0b + (FFI_TYPE_SMALL_STRUCT_1B) * 8
	mov byte ptr [r8], al ; movb	%al, (%r8)
	epilogue
ALIGN 8; ORG 0b + (FFI_TYPE_SMALL_STRUCT_2B) * 8
	mov word ptr [r8], ax ; movw	%ax, (%r8)
	epilogue
ALIGN 8; ORG 0b + (FFI_TYPE_SMALL_STRUCT_4B) * 8
...
ffi_closure_win64 PROC FRAME
	...
	mov rcx, qword ptr [FFI_TRAMPOLINE_SIZE + r10]	;movq	FFI_TRAMPOLINE_SIZE(%r10), %rcx		
	mov rdx, qword ptr [FFI_TRAMPOLINE_SIZE + 8 + r10] ;	movq	FFI_TRAMPOLINE_SIZE+8(%r10), %rdx	
	mov r8, qword ptr [FFI_TRAMPOLINE_SIZE+16+r10] ;movq	FFI_TRAMPOLINE_SIZE+16(%r10), %r8	
